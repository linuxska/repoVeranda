...
if (!class_exists('TCPDF')) {
	 ...
	 */
	define('PDF_PRODUCER', 'TCPDF 5.9.002_PHP4 (http://www.tcpdf.org)');
	...
	*/
	class TCPDF {
		 ...
		 * @since 5.8.000 (2010-08-11)
		 */
		var $colxshift = array('x' => 0, 's' => 0, 'p' => 0);
		 ...
		 */
		function SetDrawColor($col1=0, $col2=-1, $col3=-1, $col4=-1, $ret=false) {
			// set default values
			if (!is_numeric($col1)) {
				$col1 = 0;
			}
