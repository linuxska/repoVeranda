...
<div id="text">
    <h2>Bienvenidos al Sistema de Servicios de Clientes de</br>
        Veranda Jardineria y Paisajismo</h2>
    <dl>
        <dt>Inicie sesión</dt>
        ...
        <dt>Ayuda</dt>
        <dd>
        <p>Ventas, si no recuerdan sus datos de acceso usen el enlace <em>¿Olvidaste tu contraseña?</em></p>
